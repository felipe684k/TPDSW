    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-[#1c1d24] p-4 rounded-xl border border-slate-800 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xl font-bold text-slate-100">{143 + inscripciones.length}</div>
        ...
        <div className="bg-[#1c1d24] p-4 rounded-xl border border-slate-800 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xl font-bold text-slate-100">{inscripciones.length}</div>
        ...
        <div className="bg-[#1c1d24] p-4 rounded-xl border border-slate-800 shadow-sm flex items-center gap-4">
          ...
          <div>
            <div className="text-xl font-bold text-slate-100">11</div>
