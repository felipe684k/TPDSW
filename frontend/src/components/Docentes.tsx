              ...
              {docentesEjemplo.map((docente) => (
                <tr key={docente.dni} className="hover:bg-[#17181e] transition-colors">
                  ...
                  <td className="p-3 text-xs">
                    <span className="inline-flex items-center px-2 py-0.5 rounded bg-slate-900 text-slate-300 text-2xs font-medium">
                  ...
                  <td className="p-3 text-xs flex gap-2">
                    ...
                    <button className="text-rose-500 hover:text-rose-400 font-semibold text-2xs">Dar de Baja</button>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="fixed inset-0 bg-slate-950/40 backdrop-blur-xs flex items-start justify-center p-6 overflow-y-auto z-50">
          <div className="bg-[#1c1d24] rounded-xl shadow-xl w-full max-w-lg max-h-[calc(100vh-48px)] flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-4 border-b border-slate-800 flex justify-between items-center shrink-0">
              <h2 className="text-sm font-semibold text-slate-200">👨‍🏫 Registrar Nuevo Docente</h2>
              <button 
            ...
            <form className="flex-1 overflow-y-auto p-5 space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-xs font-semibold text-slate-400">Título / Especialidad *</label>
                    <input 
